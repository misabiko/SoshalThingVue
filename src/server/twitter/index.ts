...
export function parseTweets(tweets : Tweet[], options : TimelineOptions = {includeReposts: true}) : { posts : PostData[], reposts : RepostData[], quotes : QuoteData[], timelinePosts : TimelinePayload } {
